...
export const ALL_MODES      = ['klassik','beginner','expert','ultra','mathe','worte','memo','sequenz','stroop','fokus','chaos'];
export const SORT_MODES     = ['klassik','beginner','expert','ultra'];
export const BRAIN_MODES    = ['mathe','worte'];
...
const M = {
  ...
  /* PBs from save */
  anyPB:        (s) => Math.max(0, ...[s.pb_klassik,s.pb_beginner,s.pb_expert,s.pb_ultra,s.pb_mathe,s.pb_worte,s.pb_memo,s.pb_sequenz,s.pb_stroop,s.pb_fokus,s.pb_chaos].map(v=>v||0)),
